...
public final class TerminalSession extends TerminalOutput {
    ...
    private final TerminalSessionProcessMonitor mExternalProcessMonitor;
    private final Integer mExternalTerminalFileDescriptor;
    private final Integer mExternalShellPid;
    ...
    public TerminalSession(String shellPath, String cwd, String[] args, String[] env, Integer transcriptRows, TerminalSessionClient client) {
        ...
        this.mExternalProcessMonitor = null;
        this.mExternalTerminalFileDescriptor = null;
        this.mExternalShellPid = null;
        this.mClient = client;
    }
    ...
    public TerminalSession(
        ...
        int shellPid,
        TerminalSessionProcessMonitor processMonitor,
        ...
        this.mEnv = env;
        this.mTranscriptRows = transcriptRows;
        this.mExternalProcessMonitor = processMonitor;
        this.mExternalTerminalFileDescriptor = terminalFileDescriptor;
        this.mExternalShellPid = shellPid;
        this.mClient = client;
    }
    ...
    public void initializeEmulator(int columns, int rows, int cellWidthPixels, int cellHeightPixels) {
        ...
        if (mExternalTerminalFileDescriptor != null && mExternalShellPid != null) {
            mTerminalFileDescriptor = mExternalTerminalFileDescriptor;
        ...
        new Thread("TermSessionWaiter[pid=" + mShellPid + "]") {
            @Override
            public void run() {
                int processExitCode = (mExternalProcessMonitor != null)
                    ? mExternalProcessMonitor.waitForProcessExit()
    ...
    void cleanupResources(int exitStatus) {
        ...
        if (mExternalProcessMonitor != null) {
            mExternalProcessMonitor.close();
        }
