...
final class JNI {
    ...
    private static final String TERMUX_LIBRARY_PATH_PROPERTY = "murong.termux.libpath";
    ...
    static {
        ...
        try {
            ...
            if (!loaded) {
                String explicitLibraryPath = System.getProperty(TERMUX_LIBRARY_PATH_PROPERTY);
    ...
    /** Enable UTF-8 mode for the PTY input flags when needed. */
